import { Card, Divider, Popover as MuiPopover, Paper, Stack, dividerClasses } from "@mui/material";
...
export const TextMenuInner = ({ editor }: TextMenuProps) => {
	...
	>
		...
		<Popover
			trigger={
				({ handleClick }) =>
					<MemoToolbarButton active={!!states.currentColor} tooltip="Text color" onClick={handleClick}>
						<ColorLensIcon />
					</MemoToolbarButton>
			}
			popover={
